      ...
      <Container className="mt-16 space-y-24">
        ...
        <section id="streuobst" className="scroll-mt-24">
            ...
            <div className="grid gap-8 lg:grid-cols-2">
                <div className="rounded-2xl border bg-card p-8 shadow-sm">
                 ...
                 <div className="relative aspect-video rounded-2xl bg-muted/50 overflow-hidden flex items-center justify-center">
        ...
        {/* Category: Landschaftspflege */}
         <section id="landschaftspflege" className="scroll-mt-24">
             ...
             <div className="grid gap-8 lg:grid-cols-2">
                 <div className="order-2 lg:order-1 relative aspect-video rounded-2xl bg-muted/50 overflow-hidden flex items-center justify-center">
                    <span className="text-muted-foreground font-medium">[Bild: Landschaftspflege Arbeit]</span>
                 </div>
                <div className="order-1 lg:order-2 rounded-2xl border bg-card p-8 shadow-sm">
                    <p className="text-lg text-muted-foreground mb-6">
