    ...
    <div className="flex flex-col pb-24 min-h-screen">
      ...
      <div className="bg-primary/5 py-24">
        <Container className="text-center">
             <h1 className="text-4xl font-bold tracking-tight text-foreground sm:text-5xl">Unsere Arbeit</h1>
            ...
            {projects.map((project, index) => (
              ...
              >
                  ...
                  <div className="w-full aspect-[4/3] overflow-hidden rounded-md bg-muted/20 relative mb-6">
                        <div className="absolute inset-0 bg-muted/30 flex items-center justify-center group-hover:bg-muted/10 transition-colors duration-500">
                             <span className="text-muted-foreground/20 text-5xl font-serif">{index + 1}</span>
                        </div>
                         {/* Scale Effect on Image Placeholder */}
                         <div className="absolute inset-0 bg-transparent group-hover:scale-105 transition-transform duration-700 ease-in-out"></div>
                  </div>
